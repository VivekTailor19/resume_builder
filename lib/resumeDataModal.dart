...
class ResumeModal
{
  ...
  String? u_ref,u_refcompany,u_refjob,u_refemail,u_path;
  List? u_skill;
  ...
  ResumeModal({this.u_name,this.u_address,this.u_contact,this.u_email,this.u_career,this.u_education,this.u_project,
    ...
    this.u_ref,this.u_refcompany,this.u_refjob,this.u_refemail,this.u_path,this.u_skill,this.rangevalue});
}
